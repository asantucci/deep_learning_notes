...
\subsection{Word Embeddings} Although there are basic ways to represent words as numbers, these representations fail to carry meaning. Let's now move to embeddings, which are vectors that do indeed carry meaning. Let's first get an intuition for how word vectors can carry the meaning of words, starting in 1D.
