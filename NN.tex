...
\subsubsection{\texttt{LeNet-5}} The problem is to recognize handwritten digits in gray-scale images. The input is of dimension
$32 \times 32 \times 1$.

\begin{figure}[h]
  \centering   \begin{tikzpicture}     \draw (0,0) rectangle (1,1);
    \node at (0.5, 0.5) {7};
    \node at (0.5, -.25) {\scriptsize $32 \times 32 \times 1$};   \end{tikzpicture}
  \caption{An example input for the task of digit classification on grey-scale images.} \end{figure}

The first step involves applying six $5 \times 5$ filters.
