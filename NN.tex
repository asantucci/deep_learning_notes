...
Now, if we are to make predictions given a new $X = a^{[0]}$, we don't need to apply drop-out at test time.
...
Suppose we have a two dimensional data-set as follows.
