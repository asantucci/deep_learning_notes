...
\begin{figure}[h]
  \centering
    \begin{tikzpicture}
    \node[green] (a0) at (0,0) {$a^{\langle 0 \rangle}$};
    \node[draw,square,green] (g1) at (1,0) {};
    \node[green] (x1) at (1,-1) {$x^{\langle 1 \rangle}$};
    \draw[->,green] (a0) -- (g1);
    \draw[->,green] (x1) -- (g1);
    \draw[->,green] (g1) -- (1.5, 0);
    \node[green] (dots) at (1.75, 0) {$\ldots$};
    \node[green] (xtx) at (2.5, -1) {$x^{\langle T_x \rangle}$};
    \node[draw,square,green] (g2) at (2.5, 0) {};
    \draw[->,green] (dots) -- (g2);
    \draw[->,green] (xtx)  -- (g2);
    \draw[->] (g2) -- (4,0);
%     \node (encoderoutput) at (3.25, 1.25) {$\substack{\textrm{vector           % representation} \\ \textrm{of input sequence}}$};
